...
class ScanEngine:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.detectors = [
            ...
            EntropyDetector()
            # Сюда можно добавить KeywordDetector, когда он будет реализован
        ]
            ...
            for file_path in self.file_walker.walk_files():
                try:
                    with open(file_path, 'r', encoding='utf-8', errors='replace') as f:
                        content = f.read()
                    findings_in_file = self._scan_content(content, file_path)
    ...
    def _scan_content(self, content: str, file_path: str, commit: Optional[str] = None) -> List[Finding]:
        """
